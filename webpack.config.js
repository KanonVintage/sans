 ...
 */
// generated on 2018-03-06 using generator-openmrs-owa 0.6.0
'use strict';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:9994/openmrs/owa/sans/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/sans`,
	  css: `${__dirname}/app/css/sans.css`,
	  vendor : [
            'react', 'react-router',
